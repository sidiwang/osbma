...
#'  \item{delta_PFS}{censored status of `time_PFS`, 1 - observed, 2 - censored}
#'  \item{time_NL}{time to new lesion progressive disease}
#'  \item{delta_NL}{censored status of `time_NL`, 1 - observed, 2 - censored}
#'  \item{time_NT}{time to non-target lesion progressive disease}
#'  \item{delta_NT}{censored status of `time_NT`, 1 - observed, 2 - censored}
#'  \item{time_OS}{time to death}
#'  \item{delta_OS}{censored status of `time_OS`, 1 - observed, 2 - censored}
